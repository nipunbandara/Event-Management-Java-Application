      ...
      <div class = "p_details">
       ...
       <p style="font-size: small;"> <%= userName%></p>
        ...
        <br>
	      ...
	      <form action = "delete delcancel" method = "post">
          ...
          <input type = "date" name = "dob" value = "<%= dob%>" readonly><br>
          ...
          <label for = "phone">Phone</label>
            ...
            <p><td><%=gender %></td></p>
	      	...
	      	<div class = "buttondiv">
                <div class = "rbdiv"><input type="submit" class = "resetbtn" id = "cancel" formaction = "delcancel" value = "Cancel"></div>
		    	<div class = "sbdiv"><input type = "submit" class = "submitbtn" id = "submit" formaction = "delete" value = "Confirm Delete"></div>
	    	</div>
